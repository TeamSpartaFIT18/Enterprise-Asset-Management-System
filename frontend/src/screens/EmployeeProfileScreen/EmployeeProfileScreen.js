                ...
                <strong>
                  {skills &&
                    skills.map((skill) => (
                      <strong>
                        {' '}
                        <i className="skillsBullet fas fa-circle"></i> {skill}{' '}
                        &nbsp;&nbsp;{' '}
                      </strong>
                    ))}{' '}
                </strong>
              </p>
              <p className="profDet">{profile ? profile.address : 'null'}</p>
              <p className="profDet">{profile ? profile.contact : 'null'}</p>
              <p className="profDet">{profile ? profile.bio : 'null'}</p>
              <p className="profDet">
                Since &nbsp;
                {profile.createdAt ? profile.createdAt.slice(0, 10) : 'null'}
              </p>
            </Col>
          </Row>
        </Card.Body>
